...
class HighRes3DNetArtefactRemoval(BaseNet):
    """
    ...
    def __init__(self,
                 ...
                 b_regularizer=None,
                 acti_func='prelu',
                 name='HighRes3DNetArtefactRemoval'):

        super(HighRes3DNetArtefactRemoval, self).__init__(
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        fc_layer = ConvolutionalLayer(
            ...
            name=params['name'],
            with_bn=False)
        flow = fc_layer(flow, is_training, keep_prob=None)
        ...
        elem_layer = ElementwiseLayer('SUM')
        flow = elem_layer(flow, images)
        layer_instances.append((elem_layer, flow))
