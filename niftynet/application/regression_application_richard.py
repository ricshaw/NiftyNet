...
from niftynet.engine.windows_aggregator_regression import RegressionAggregator
...
class RegressionApplication(BaseApplication):
    ...
    def __init__(self, net_param, action_param, action):
        ...
        self.SUPPORTED_SAMPLING = {
            ...
            'resize_regress': (self.initialise_resize_sampler,
                               self.initialise_resize_sampler,
                               self.initialise_regression_aggregator),
    ...
    def initialise_regression_aggregator(self):
        self.output_decoder = RegressionAggregator(
            image_reader=self.readers[0],
            output_path=self.action_param.save_seg_dir)
    ...
    def connect_data_and_network(self,
        ...
        if self.is_training:
            ...
            weight_map = None if data_dict.get('weight', None) is None \
                else data_dict.get('weight', None)
            ...
            print 'Training: ', self.is_training
            print '\nNet out\n', net_out
